...
class Article 
{
     ...
     * @param object $conn Connection to the database
     * 
     * @return boolean True if the udate was successful, false otherwise
     */
    ...
    /**
     * Insert a new article with its current property vakues
     * 
     * @param object $conn Connection to the database
     * 
     * @return boolean True if the udate was successful, false otherwise
    ...
    public function setImageFile($conn, $filename)
    {
        ...
        $stmt->bindValue(':id', $this->id, PDO::PARAM_INT);
        $stmt->bindValue(':image_file', $filename, 
            $filename == null ? PDO::PARAM_NULL : PDO::PARAM_STR);
     ...
     * @param object $conn Connection to the database
     * 
     * @return mixed The published at date and tiem if successful, null otherwise
     */
